...
func (ts *TokenService) NewAccessToken(userID int) string {
	return ts.NewUserToken(userID, AccessTokenType, ts.accessTokenDuration)
}

func (ts *TokenService) NewRefreshToken(userID int) string {
	return ts.NewUserToken(userID, RefreshTokenType, ts.refreshTokenDuration)
}

func (ts *TokenService) NewUserToken(userID int, tokenType string, duration time.Duration) string {
